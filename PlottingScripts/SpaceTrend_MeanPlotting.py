#This plotting script shows the ratio of space optimized vs naive protocols in discrete control simulations
#
#Steven Large
#May16th 2018
...
NaiveName = "MeanWork_Naive.dat"
SpaceName = "MeanWork_SpaceOpt.dat"
...
ax[0].plot(CPVals_Space,Work_Space,'g--',linewidth=2.5)

ax[0].errorbar(CPVals_Naive,Work_Naive,yerr=Err_Naive,fmt='o',color='r')
ax[0].errorbar(CPVals_Space,Work_Space,yerr=Err_Space,fmt='o',color='g')
...
ax[0].set_ylabel(r'Mean excess work $\langle W_{\rm ex}\rangle_{\Lambda}$',fontsize=20)
